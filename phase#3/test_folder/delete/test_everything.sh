...
./test.sh ./input/delete_4.txt > ./output/output_delete_4.txt
./test.sh ./input/delete_5.txt > ./output/output_delete_5.txt
./test.sh ./input/delete_6.txt > ./output/output_delete_6.txt

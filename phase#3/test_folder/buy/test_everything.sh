...
./test.sh ./input/buy_4.txt > ./output/output_buy_4.txt
./test.sh ./input/buy_5.txt > ./output/output_buy_5.txt
./test.sh ./input/buy_6.txt > ./output/output_buy_6.txt
./test.sh ./input/buy_7.txt > ./output/output_buy_7.txt
./test.sh ./input/buy_8.txt > ./output/output_buy_8.txt
./test.sh ./input/buy_9.txt > ./output/output_buy_9.txt
./test.sh ./input/buy_10.txt > ./output/output_buy_10.txt
./test.sh ./input/buy_11.txt > ./output/output_buy_11.txt
./test.sh ./input/buy_12.txt > ./output/output_buy_12.txt
./test.sh ./input/buy_13.txt > ./output/output_buy_13.txt
./test.sh ./input/buy_14.txt > ./output/output_buy_14.txt
